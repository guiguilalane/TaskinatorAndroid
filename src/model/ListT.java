...
public class ListT implements Iterable<Task> {
	 ...
	 *            the name of the task list
	 * @param state
	 *            whether the list is open, whether tasks should be displayed
	 */
	...
	/**
	 * @param taskToAdd
	 *            the task to add in the task list
	...
	/**
	 * @param pos
	 *            the position of the task to remove from the task list
